    ...
    return (
      <div className="addproduct">
        ...
        <div className="addproduct-main">
          ...
          <div className="addproduct-distance-input">
            <FormOptionInputProduct optionList={PRODUCT_CATEGORIES} />
          </div>
          <div className="addproduct-distance-input">
            <FormOptionInputProduct optionList={PRODUCT_BRAND} />
          </div>
          <div className="addproduct-distance-input">
            <FormInputProduct />
          </div>
          <div className="addproduct-distance-input">
            <FormOptionInputProduct optionList={PRODUCT_SIZE} />
          </div>
          <div className="addproduct-distance-input">
            <FormOptionInputProduct optionList={PRODUCT_COLORS} />
          </div>
          <div className="addproduct-distance-input">
            <FormInputProduct />
          </div>
          <div className="addproduct-distance-input">
            <FormInputProduct isLarge={isLarge}/>
          </div>
          <div className="addproduct-button">
            <Button className="button" addproductButton="button-cancel" addproductText="button-text-cancel" buttonname="Cancel" />
            <Button addproductButton="button-submit" addproductText="button-text-complete" buttonname="Complete" />
          </div>
        </div>
      </div>
    );
